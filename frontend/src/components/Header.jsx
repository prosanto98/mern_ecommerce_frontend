    ...
    return (
        <header className='fixed right-0 left-0 mx-auto z-10'>
            <div className='max-padd-container bg-white'>
                <divt className='flexBetween py-4 max-xs:px-2'>
                    <div className='flexCenter gap-x-20 '>
                        ...
                        {/* Navabar mobile */}
                        <Navbar
                            containerStyles={`${menuOpened ? "flex items-start flex-col gap-y-12 fixed top-20 right-8 p-12 bd-white rounded-3xl shadow-md w-64 medium-16 ring-1 ring-state-900/5 transition-all duration-300" :
